...
.student-snapshot{
    ...
    border-radius:16px;
    background:linear-gradient(110deg,#ecfbfc,#ffffff 58%,#fff8e8);
    box-shadow:var(--shadow);
}
...
=======
                <div class="student-snapshot">
                    ...
                    <div class="student-avatar">
                        ${esc(currentUser.name).charAt(0).toUpperCase()}
                    </div>

                    <div>
                        <h2>${esc(currentUser.name)}</h2>
                        <p>${esc(currentUser.studentId || "Student ID unavailable")} · ${esc(currentUser.email)}</p>
                    </div>

                    <div class="student-details">
                        <div class="student-detail">
                            <strong>${esc(currentUser.department || "Not assigned")}</strong>
                            <span>Department</span>
                        </div>
                        <div class="student-detail">
                            <strong>${esc(currentUser.batch || "Not assigned")}</strong>
                            <span>Batch</span>
                        </div>
                        <div class="student-detail">
                            <strong>${esc((currentUser.attendance || 0) + "%")}</strong>
