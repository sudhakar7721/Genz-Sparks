    ...
    if(currentUser.role === "faculty"){
        ...
        addSection(
            ...
            [
                ...
                ["faculty-mark-requests","✅","Mark Change Requests"]
    ...
    if(currentUser.role === "hod"){
        ...
        addSection(
            ...
            [
                ...
                ["hod-mark-requests","✅","Mark Approval Requests"],

                ["hod-faculty","👨‍🏫","Faculty Directory"]
...
function go(pageId){
    ...
    if(pageId === "faculty-mark-requests"){
        renderFacultyMarkRequests();
    }

    if(pageId === "hod-dashboard"){
        renderHodDashboard();
    }

    if(pageId === "hod-mark-requests"){
        renderHodMarkRequests();
    }

    if(pageId === "hod-faculty"){
