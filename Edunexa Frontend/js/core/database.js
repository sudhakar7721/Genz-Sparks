...
let db = loadDatabase();
// Backward-compatible migrations for databases created before newer modules.
db.feedbacks = Array.isArray(db.feedbacks) ? db.feedbacks : [];
db.markRequests = Array.isArray(db.markRequests) ? db.markRequests : [];
...
function createDefaultDatabase(){
    ...
    return {
        ...
        // Faculty -> HOD mark correction requests.
        // exam: "ca1" | "ca2" | "model"
...
function seedDatabase(){
    ...
    db.users = [
...

        {
            ...
            basicSubjects:["Data Analytics"],
            extraSubjects:[],
            qualification:"Ph.D. in Data Science",
            experience:"14 Years",
            office:"Block A - Room 101",
            phone:"+91 90000 20001",
            extraInfo:"Head of Department — reviews faculty mark-correction requests and oversees department academics."
        },
    ...
    db.markRequests = [

        {
            ...
            exam:"ca2",
            examLabel:"C2 (CA 2)",
            subjectCategory:"Python",
            currentMark:86,
            requestedMark:90,
            reason:"Revaluation after re-checking the answer script — the student was not credited for a partially correct query in Q4.",
            status:"Pending",
