...
CORS_ORIGINS=[x.strip() for x in os.getenv('EDUNEXA_CORS_ORIGINS','http://127.0.0.1:5500,http://localhost:5500,http://127.0.0.1:5173,http://localhost:5173').split(',') if x.strip()]
